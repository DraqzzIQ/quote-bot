...
public class Messages
{
    ...
    public static MessageComponent CreateQuoteButtonComponent(string quoteName)
    {
        return new ComponentBuilder().WithButton(label: "Upvote", customId: ADD_UPVOTE_BUTTON_PREFIX + quoteName).WithButton(label: "Remove Upvote", customId: REMOVE_UPVOTE_BUTTON_PREFIX + quoteName).WithButton("Edit", customId: EDIT_QUOTE_BUTTON_PREFIX + quoteName).Build();
    }
